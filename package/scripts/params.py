...
sshpass_location = config['configurations']['greenplum-env']['sshpass_location']
...
admin_user_pwd = config['configurations']['greenplum-env']['admin_user_pwd']
admin_group = config['configurations']['greenplum-env']['admin_group']
gpmon_password = config['configurations']['greenplum-env']['gpmon_password']
